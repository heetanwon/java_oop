...
public class AMS {
	   ...
	   private static void createAccount() {
	      ...
	      System.out.print("비밀번호: "); // 런타임 -로직 바꾸기
	      ...
	      if (accountType == 1) {
	         ...
	         //Calendar로 바꾸기
	         rentDate = scanner.nextLine();	         account = new MinusAccount(num, owner, passwd, money, rentMoney, rentDate);
	   ...
	   //입금
		...
		public static void withdraw() {
			...
			ArrayAccountRepository arrayreAccountRepository = new ArrayAccountRepository();
			 System.out.print("계좌번호를 입력해주세요 ");
			 String drawNumber = scanner.next();
			  account= arrayreAccountRepository.findByNumber(drawNumber);
			 if(account.equals(drawNumber)) {
