 ...
 *
 */
public class Account_application {
...
//		account.accountNumber = "1111-2222-3333";
		account.setAccountNumber("1111-3333");
	
//		account.accountOwner = "김희원";
		account.setAccountOwner("김희원");
		...
		if(confirm) { //비밀번호 일치시
			...
			restMoney = account.withraw(100000);
		...
		//Account.BANK_NAME="";
		//final이므로 이름을 바꾸려고 하면 문법적인 오류 발생.
